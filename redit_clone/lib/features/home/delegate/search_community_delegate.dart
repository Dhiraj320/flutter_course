...
class SearchCommunityDelegate extends SearchDelegate {
  ...
  @override
  // all function name related to appBar like buildAction is end part of appBar
  ...
  Widget buildSuggestions(BuildContext context) {
        ...
        data: (communities) => ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return ListTile(
                ...
                onTap: ()=>navigateToCommunityFromSearch(context,community.name),
              );
            }),
   ...
   void navigateToCommunityFromSearch(
      BuildContext context, String communityName) {
