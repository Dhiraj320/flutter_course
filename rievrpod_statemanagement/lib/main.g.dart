...
String _$fetchUserHash() => r'45742b035c1aa4b4fbfabe0e9d5582e948d7f730';
...
/// See also [fetchUser].
class FetchUserFamily extends Family<AsyncValue<FutureUser>> {
  /// See also [fetchUser].
...
/// See also [fetchUser].
class FetchUserProvider extends AutoDisposeFutureProvider<FutureUser> {
  /// See also [fetchUser].
  FetchUserProvider(
    String input,
  ) : this._internal(
  ...
  Override overrideWith(
    FutureOr<FutureUser> Function(FetchUserRef provider) create,
  ) {
  ...
  @override
  AutoDisposeFutureProviderElement<FutureUser> createElement() {
...
mixin FetchUserRef on AutoDisposeFutureProviderRef<FutureUser> {
  /// The parameter `input` of this provider.
  String get input;
}

class _FetchUserProviderElement
    extends AutoDisposeFutureProviderElement<FutureUser> with FetchUserRef {
